...
MAKE 
======
1.- Install the libraries sdsl and rmq. Note that, in our experiments, we set the rmq blok size in 64, the faster configuration of the rmq library. To do that you have set RMQRMM64::BLK = RMQRMM64::SS = 64 in the header file oncludes/RMQRMM64.h before to compile it<br />
